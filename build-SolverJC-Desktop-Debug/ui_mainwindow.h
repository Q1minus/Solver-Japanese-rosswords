...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(989, 677);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        formLayoutWidget = new QWidget(centralWidget);
        formLayoutWidget->setObjectName(QStringLiteral("formLayoutWidget"));
        formLayoutWidget->setGeometry(QRect(20, 10, 101, 71));
        ...
        pushButton->setGeometry(QRect(20, 90, 99, 27));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        nLabel->setText(QApplication::translate("MainWindow", "N = ", 0));
        nLineEdit->setText(QApplication::translate("MainWindow", "<30", 0));
        mLabel->setText(QApplication::translate("MainWindow", "M = ", 0));
        mLineEdit->setText(QApplication::translate("MainWindow", "<30", 0));
